// ---- Firebase apps initialization ----
    ...
    // UPDATED Firebase config for comments
    ...
    function initializeFirebaseApps() {
        ...
        // Initialize commentsApp with the new configuration
    ...
    function updateCommentCounts() {
        Object.keys(postDataCache).forEach(postId => {
            const postElement = document.getElementById(`post_${postId}`);
            // No longer check for data.video, apply to all posts
            if (postElement) {
    ...
    function setupLiveListeners() {
        ...
        // Live listener for comments with the new config
    ...
    if (showOnlyMyPosts) {
        Promise.all([
            ...
            commentsDb.ref("comments").once("value"), // Fetch initial comments data
