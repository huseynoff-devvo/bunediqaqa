import { initializeApp } from "https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";
  ...
  const countdownEl = document.getElementById("countdown"); // Hələ də referans olaraq qalır, ancaq istifadə edilməyəcək
  ...
  // Xəta mesajını göstərmək (gözləmə müddəti ilə əlaqədar xətalar silindi)
  ...
  function draw() {
    ...
    // Əgər önizləmə pikseli varsa (cooldown yoxlaması silindi)
    if (previewPixel) {
  ...
  // Animasiya dövrü (updateCooldownUI çağırışı silindi)
  function animate() {
    draw();
  ...
  // updateCooldownUI funksiyası silindi
  ...
  // Piksel yerləşdirmək (cooldown yoxlaması silindi)
